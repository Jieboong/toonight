...
for original in originals :
    ...
    section = driver.find_elements(By.CLASS_NAME,'relative.day-section')[3]
...
try :
	s3.meta.client.upload_file(filename, BUCKET_NAME, 'kakao/thu/'+datetime.datetime.strftime(datetime.date.today(),'%Y-%m-%d' )+'.csv', ExtraArgs={
		'ACL' : 'public-read'
	})
	result = True
except : 
